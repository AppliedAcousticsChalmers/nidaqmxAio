...
#Prints the .np[zy] files pressent in the specified directory and returns the file name selected by the user. If no selection is given the first filename of the list is returned, if all is given a list with all the filenames is returned.
