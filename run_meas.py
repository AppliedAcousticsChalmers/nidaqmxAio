...
if __name__ == '__main__':
    ...
    p.add("-pp", "--postProcess", help="Post proccessing type", type=str, choices={"TF", "T60Shr"})
    ...
    if args.postProcess:
        ...
        for current_file in filenames:
            ...
            if args.postProcess == "TF":
                processedData = pp.TFcalc(current_file,  args.bufferSize, calibrationData)
            elif args.postProcess == "T60Shr":
                processedData = pp.T60Shroeder(current_file, args.bufferSize, calibrationData)
                # Saving the data
